      ...
      >
        <SafeAreaView className="flex-1">
          ...
          <View className="flex-1 items-center space-y-6">
            {/* Play Now Button */}
            <Pressable
              onPress={() => router.push("./levelOne")}
              className="bg-slate-900 py-3 px-6 w-5/6 rounded-lg shadow-md border border-rose-600"
            >
              <Text className="text-rose-400 text-2xl font-inter-semibold">Discrimination Activity 🎮</Text>
            ...
            <Pressable
              onPress={() => router.push("./levelTwo")}
              className="bg-slate-900 py-3 px-6 w-5/6 rounded-lg shadow-md border border-emerald-600"
            >
              <Text className="text-emerald-400 text-2xl font-inter-semibold">Discrimination Activity 🎮</Text>
